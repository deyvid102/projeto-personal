  ...
  return (
    <div className="h-screen flex bg-white w-full overflow-hidden font-sans relative">
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1 group">
                <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1 group-focus-within:text-black transition-colors">
                  E-mail
                </label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    className={`w-full p-3.5 pl-11 bg-gray-50 border ${email && !emailValido ? 'border-red-200' : 'border-gray-100'} rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 focus:border-black outline-none text-xs font-bold transition-all`}
                    value={email} 
              ...
              <div className="space-y-1 relative">
                <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1 transition-colors">
                  Sexo
                </label>
                <div className="relative">
                  <button
                    ...
                    className="w-full p-3.5 pl-11 pr-8 bg-gray-50 border border-gray-100 rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 focus:border-black outline-none text-left text-xs font-bold transition-all flex items-center"
                  >
                    <FaVenusMars className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300 size-3" />
                    <span className={sexo !== "" ? "text-gray-900" : "text-gray-400 uppercase"}>
                      {sexo !== "" ? opcoesSexo.find(o => o.value === sexo)?.label : "sexo"}
                    </span>
                    <FaChevronDown className={`absolute right-3 top-1/2 -translate-y-1/2 text-gray-300 transition-transform ${showSelect ? 'rotate-180' : ''}`} size={10} />
                  </button>
              ...
              <div className="space-y-1 group">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    placeholder="••••••••"
                    className="w-full p-3.5 pl-11 bg-gray-50 border border-gray-100 rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 focus:border-black outline-none text-xs font-bold transition-all"
                    value={senha} 
              ...
              <div className="space-y-1 group">
                ...
                <div className="relative">
                  ...
                  <input 
                    type={verSenha ? "text" : "password"} 
                    placeholder="••••••••"
                    className={`w-full p-3.5 pl-11 bg-gray-50 border ${senha && repitaSenha && !senhasCoincidem ? 'border-red-200' : 'border-gray-100'} rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 focus:border-black outline-none text-xs font-bold transition-all`}
                    value={repitaSenha} 
      ...
      <div className="hidden md:block md:w-1/2 relative bg-cover bg-center" 
           style={{ backgroundImage: "url('https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=1469&auto=format&fit=crop')" }}>
